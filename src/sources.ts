...
export const SOURCES: FeedSource[] = [
  ...
  },
  {
    ...
    sourceType: "media",
    fetchMode: "html",
    parser: "focus_taiwan_business_html",
    articleHosts: ["focustaiwan.tw", "www.focustaiwan.tw"],
  },
  {
    name: "Taipei Times Business",
    ...
    sourceType: "media",
    fetchMode: "html",
    parser: "taipei_times_biz_html",
    articleHosts: ["www.taipeitimes.com", "taipeitimes.com"],
  },
  {
    name: "TrendForce Semiconductors",
    url: "https://www.trendforce.com/news/category/semiconductors/",
    category: "taiwan_stocks",
    enabledByDefault: true,
    priority: 68,
    sourceType: "media",
    fetchMode: "html",
    parser: "trendforce_semiconductors_html",
  ...
  {
    name: "RTI Business",
    url: "https://en.rti.org.tw/news/category/business",
    category: "taiwan_stocks",
    enabledByDefault: false,
    priority: 54,
    sourceType: "media",
    fetchMode: "html",
    parser: "rti_business_html",
    articleHosts: ["en.rti.org.tw", "rti.org.tw"],
  },
  {
