...
const env: Env = {
  ...
  ENABLE_PRIVATE_NEWS: process.env.ENABLE_PRIVATE_NEWS,
  FMP_API_KEY: process.env.FMP_API_KEY,
  ENABLE_FMP_STOCK_NEWS: process.env.ENABLE_FMP_STOCK_NEWS,
  OPENROUTER_API_KEY: process.env.OPENROUTER_API_KEY,
  OPENROUTER_TRANSLATION_MODEL: process.env.OPENROUTER_TRANSLATION_MODEL,
  OPENROUTER_CLASSIFICATION_MODEL: process.env.OPENROUTER_CLASSIFICATION_MODEL,
